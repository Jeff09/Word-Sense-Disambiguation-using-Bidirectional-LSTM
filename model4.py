...
train_target_sense_to_context = build_context(train_data, word_to_id)
...
# make numeric
train_ndata = convert_to_numeric(train_data, word_to_id, target_word_to_id, target_sense_to_id, n_senses_from_target_id, target_sense_to_context_embedding, is_training = True)
...
if __name__ == '__main__':
    ...
    val_forward_data, val_backward_data, val_target_sense_ids, val_sense_embedding = get_data(train_data, n_step_f, n_step_b)
